...
if (__name__ == "__main__"):
    ...
    for dkey in ["l568m160", "l568m80", "l408m40", "l328m27", "l328m20"]:
       ...
       index=x.GetIndexFromDkey(dkey)
       T=x.data[index]["sdata"]["T"]
       C=x.data[index]["sdata"]["chi"]
       plt.plot(T,C,colorstr+"o")
       CInter=scipy.interpolate.interp1d(T,C,kind="cubic",fill_value="extrapolate")
       plt.plot(TInter,CInter(TInter),colorstr+"-")
       colorid=colorid+1
    plt.show()
